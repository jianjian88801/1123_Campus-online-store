<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='商铺名称' prop="shangjiaName">
               <el-input v-model="ruleForm.shangjiaName"  placeholder='商铺名称' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='商铺信用类型' prop="shangjiaXingjiTypes">
                 <el-select v-model="ruleForm.shangjiaXingjiTypes" disabled placeholder='请选择商铺信用类型'>
                     <el-option
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='shangjia'"  label="商铺简介" prop="shangjiaContent">
                 <editor
