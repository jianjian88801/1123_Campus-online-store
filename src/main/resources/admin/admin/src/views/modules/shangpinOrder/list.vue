                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanwangshangshangpu/upload/shangpinOrderMuBan.xls"
                        >批量导入商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
                                style="display: inline-block"
                                action="xiaoyuanwangshangshangpu/file/upload"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 1 && sessionTable=='shangjia' && userId==scope.row.shangpinShangjiaId" type="primary" icon="el-icon-reading" size="mini"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '配送人': "shangpinOrderCourierName",
                     '配送人联系方式': "shangpinOrderCourierNumber",
        ...
        methods: {
            ...
            if(this.shangpinOrderCourierNumber == ""
				|| this.shangpinOrderCourierNumber == null
				|| this.shangpinOrderCourierNumber == "null"){
				return this.$message.error("配送人联系方式不能为空");
			}
 			if(this.shangpinOrderCourierName == ""
				|| this.shangpinOrderCourierName == null
				|| this.shangpinOrderCourierName == "null"){
				return this.$message.error("配送人不能为空");
			}
