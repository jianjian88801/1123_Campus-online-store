    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="配送人" prop="shangpinOrderCourierName">
                       <el-input v-model="ruleForm.shangpinOrderCourierName"
                                 placeholder="配送人" clearable  :readonly="ro.shangpinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="配送人" prop="shangpinOrderCourierName">
                           <el-input v-model="ruleForm.shangpinOrderCourierName"
                                     placeholder="配送人" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="配送人联系方式" prop="shangpinOrderCourierNumber">
                       <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                 placeholder="配送人联系方式" clearable  :readonly="ro.shangpinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="配送人联系方式" prop="shangpinOrderCourierNumber">
                           <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                     placeholder="配送人联系方式" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinOrderCourierNumber: [
                              { required: true, message: '配送人联系方式不能为空', trigger: 'blur' },
                          ],
                   shangpinOrderTypes: [
