...
//                            shangjiaEntity.setShangjiaName(data.get(0));                    //商铺名称 要改的
...
//                            shangjiaEntity.setShangjiaXingjiTypes(Integer.valueOf(data.get(0)));   //商铺信用类型 要改的
...
//                            shangjiaEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(shangjia.getId(),username, "shangjia", "商铺");
        R r = R.ok();
        r.put("token", token);
        r.put("role","商铺");
